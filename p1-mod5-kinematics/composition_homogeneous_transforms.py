...
Tb_a = (Rb_a.col_join(Matrix([[0,0,0]]))).row_join(tb_a.col_join(Matrix([[1]])))

Te_b = (Re_b.col_join(Matrix([[0,0,0]]))).row_join(te_b.col_join(Matrix([[1]])))

Tc_a = (Rc_a.col_join(Matrix([[0,0,0]]))).row_join(tc_a.col_join(Matrix([[1]])))

Td_c = (Rd_c.col_join(Matrix([[0,0,0]]))).row_join(td_c.col_join(Matrix([[1]])))

Te_d = (Re_d.col_join(Matrix([[0,0,0]]))).row_join(te_d.col_join(Matrix([[1]])))       
