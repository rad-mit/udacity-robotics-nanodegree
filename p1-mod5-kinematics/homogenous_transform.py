...
T = Matrix([[cos(q1), 0.0, sin(q1), 1.0], [0.0, 1.0, 0.0, 0.0], [-sin(q1), 0.0, cos(q1), 30], [0.0, 0.0, 0.0, 1.0]])     # T Should be a 4x4 homogeneous Transform
P_new =  T*P# 

print(P_new)

P_new_res = P_new.evalf(subs={q1:110*180/pi})
print(P_new_res)
